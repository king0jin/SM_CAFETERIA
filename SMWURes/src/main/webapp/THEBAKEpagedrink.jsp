...
<%
    ...
    try {
        ...
        String query = "SELECT menu_name, menu_price,imageurl FROM menu where cafeteria_code = 'tb' AND menu_category='커피/음료'";
...
<div class="mainpage">
    <ul class="category">
        ...
        <li class="menu-item selected" id="drink" onclick="selectMenu('drink')"><a href="THEBAKEpagedrink.jsp">커피/음료</a></li>
